...
This spec defines the project directory structure and organization for the vai TUI application.
...
- **tui-framework**: Depends on this structure for organizing Bubble Tea components
- **vim-navigation**: Defines the `internal/vim/` package responsibilities
- **chat-buffer**: Defines the `internal/chat/` package responsibilities
- **session-manager**: Defines the `internal/session/` package responsibilities
